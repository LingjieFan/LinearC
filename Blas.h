...
#ifdef _MSC_VER
#ifdef _WIN64
#pragma comment(lib, "./Win64/libblas.lib")
#else
#pragma comment(lib, "./Win32/libblas.lib")
#endif /*_WIN64*/
#endif /*_MSC_VER*/
...
extern void zscal_(int *size, _Dcomplex *scale, _Dcomplex *vector, int *inc);

extern _Dcomplex zdotu_(int *size, _Dcomplex *vector1, int *inc1, _Dcomplex *vector2, int *inc2);

extern _Dcomplex zdotc_(int *n, _Dcomplex *vector1, int *inc1, _Dcomplex *vector2, int *inc2);

extern void zcopy_(int *size, _Dcomplex *vector1, int *inc1, _Dcomplex *vector2, int *inc2);

extern void zgemm_(char *transA, char *transB, int *m, int *n, int *k, _Dcomplex *alpha, _Dcomplex *matrixA, int *lda, \
    _Dcomplex *matrixB, int *ldb, _Dcomplex *beta, _Dcomplex *matrixC, int *ldc);
